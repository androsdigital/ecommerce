    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                <li class="nav-item"><a @class(['nav-link', 'active' => request()->routeIs('home')]) aria-current="page" href="{{ route('home') }}">Inicio</a></li>
                ...
                <li class="nav-item"><a @class(['nav-link', 'active' => request()->routeIs('about')]) href="{{ route('about') }}">Acerca de</a></li>
            </ul>
        </div>
    </div>
</nav>
